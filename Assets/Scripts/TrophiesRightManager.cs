...
public class TrophiesRightManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        beforeHangBear = GameObject.Find("TrophiesRight(BeforeHangBear)");
        afterHangBear = GameObject.Find("TrophiesRight(AfterHangBear)");
    }
