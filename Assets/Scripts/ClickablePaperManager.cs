...
public class ClickablePaperManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        beforeHangBear = GameObject.Find("ClickablePaper(BeforeHangBear)");
        afterHangBear = GameObject.Find("ClickablePaper(AfterHangBear)");
    }
